...
}var $author$project$Types$Noop = {$: 5};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {Y: fragment, Z: host, aC: path, ac: port_, af: protocol, ag: query};
	});
...
var $author$project$Model$initialModel = F2(
	function (route, key) {
		return {
			...
			aE: $author$project$Data$projects,
			aG: $author$project$Data$reading,
			aI: route,
			aN: {aD: $author$project$Data$poetry, aF: $author$project$Data$prose}
		};
	});
		...
		A2(
			...
			_Utils_update(
				url,
				{
					...
					aC: A2($elm$core$Maybe$withDefault, '', url.Y)
				})));
};
	...
	switch (_v0) {
		...
		case 2:
			return A2(
				...
				A2($elm$core$List$concatMap, $author$project$View$showProject, model.aE));
		case 3:
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				A3($elm$core$Dict$foldl, $author$project$View$showBooksByYear, _List_Nil, model.aG));
		default:
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		av: $author$project$Model$init,
		az: $author$project$Types$UrlChange,
		aA: function (_v0) {
		...
		aK: $author$project$Update$update,
		aL: $author$project$View$view
	});
